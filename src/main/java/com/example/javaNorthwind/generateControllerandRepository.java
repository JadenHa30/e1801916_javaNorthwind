package com.example.javaNorthwind; //your package

import java.io.File;
import java.io.FileWriter;

public class generateControllerandRepository {
    private static File file = new File("C:\\TEMP\\javaNorthwind\\javaNorthwind\\src\\main\\java\\com\\example\\javaNorthwind"); //your folder
    //Create the file
            ...
            if (checkFile.isDirectory()) {checkAndGetFileName(checkFile);}
                ...
                if(checkFile.isFile()){
                    ...
                    if(extension.equals("java")) {
                        ...
                        if(!newFileName.equals("generateControllerandRepository") && !newFileName.equals("WebSecurityConfig.java") && !newFileName.equals("JavaNorthwindApplication.java") && !newFileName.contains("Controller") && !newFileName.contains("Repository")){
    ...
    public static void createRepository(String name){
        try {
            ...
            write.write("package com.example.javaNorthwind;\n\n");
